...
$folders = [];
$folderResult = $conn->query("SELECT id, name FROM folders ORDER BY name");
...
<head>
    ...
    <style>
        ...
        [data-theme="dark"] {
            ...
            --gray: #98A2B3;
            --white: #2A2A2A;
            --term-color: rgba(100, 200, 100, 0.2);
            --definition-color: rgba(200, 100, 100, 0.2);
            --term-selection: rgba(100, 200, 100, 0.4);
            --definition-selection: rgba(200, 100, 100, 0.4);
        }
    ...
    <script>
        ...
        function loadHighlightsForPage(pageNumber) {
            ...
            $.ajax({
                ...
                error: function() {
                    console.error('Error loading highlights');
                }
            });
        }
