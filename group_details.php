...
$stmt = $pdo->prepare("
    ...
    GROUP BY g.id
");
$stmt->execute([$studentId, $studentId, $groupId]);
$group = $stmt->fetch();
            ...
            try {
                ...
                if ($stmt->fetch()) {
                    ...
                    $stmt = $pdo->prepare("
                        ...
                        VALUES (?, ?, ?, NOW())
                    ");
                    $stmt->execute([$groupId, $folderId, $studentId]);
    ...
    elseif (isset($_POST['leave-group'])) {
        if (!$group['is_member']) {
            ...
            try {
                ...
                header('Location: student_group.php?left=' . $groupId);
                exit();
            } catch (PDOException $e) {
                $pdo->rollBack();
...
<body data-theme="<?php echo htmlspecialchars($theme); ?>">
  <div class="app-container">
    <!-- Sidebar - Desktop -->
<!-- Replace the existing sidebar section with this code -->
<!-- Sidebar - Desktop -->
    <aside class="sidebar">
      ...
      <div class="nav-section">
        ...
        <?php if ($_SESSION['role'] === 'student'): ?>
          ...
          <a href="student_public_group.php" class="nav-item active">
        ...
        <?php elseif ($_SESSION['role'] === 'admin'): ?>
          ...
          <a href="admin_manage_users.php" class="nav-item">
            <i class="fas fa-users-cog"></i>
            <span>Manage Users</span>
          </a>
          <a href="admin_manage_classes.php" class="nav-item">
            <i class="fas fa-chalkboard"></i>
            <span>Manage Classes</span>
          </a>
          <a href="admin_manage_groups.php" class="nav-item active">
            <i class="fas fa-users"></i>
            <span>Manage Groups</span>
          </a>
          <a href="admin_system_settings.php" class="nav-item">
      ...
      <div class="group-header animate-fade">
        ...
        <div class="group-header-content">
          <h1 class="group-title-large">
            ...
            <span class="text-sm" style="font-weight: normal; color: var(--text-medium);">
          ...
          <?php if ($group['is_member']): ?>
            <div class="group-actions">
              ...
              <?php if ($group['is_admin']): ?>
                <a href="manage_group.php?id=<?php echo $groupId; ?>" class="btn btn-outline">
                  <i class="fas fa-cog"></i> Manage Group
                </a>
              <?php endif; ?>
              <form method="POST" style="display: inline;">
                <button type="submit" name="leave-group" class="btn btn-outline" style="color: var(--danger);" 
          ...
          <div class="back-button-container">
            <a href="student_group.php" class="btn btn-outline">
...
<!-- Replace the bottom-nav-container section with this code -->
<div class="bottom-nav-container">
  <nav class="bottom-nav">
    <?php if ($_SESSION['role'] === 'student'): ?>
      ...
      <a href="student_flashcards/flashcard.php" class="nav-item-mobile">
        <i class="fas fa-layer-group"></i>
        <span>Decks</span>
      </a>
      ...
      <div class="fab-container">
        <button class="fab" id="mobileCreateGroupBtn" onclick="location.href='student_group.php'">
      ...
      <a href="student_public_group.php" class="nav-item-mobile active">
        <i class="fas fa-users"></i>
        <span>Groups</span>
      </a>
    ...
    <?php elseif ($_SESSION['role'] === 'admin'): ?>
      ...
      <a href="admin_manage_users.php" class="nav-item-mobile">
        <i class="fas fa-users-cog"></i>
        <span>Users</span>
      </a>
      
      <div class="fab-container">
        <button class="fab" id="mobileCreateGroupBtn" onclick="location.href='admin_manage_groups.php'">
          <i class="fas fa-plus"></i>
        </button>
      </div>
      ...
      <a href="admin_manage_classes.php" class="nav-item-mobile">
        <i class="fas fa-chalkboard"></i>
        <span>Classes</span>
      </a>
      <a href="admin_system_settings.php" class="nav-item-mobile">
        <i class="fas fa-cogs"></i>
        <span>Settings</span>
      </a>
    <?php endif; ?>
  ...
  <script>
    ...
    // Show/hide create post form with animation
      ...
      if (successAlert) {
        setTimeout(() => {
          ...
          setTimeout(() => {
            ...
            const shareForm = document.getElementById('createPostForm');
            if (shareForm) {
