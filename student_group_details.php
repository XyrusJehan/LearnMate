...
<body data-theme="<?php echo htmlspecialchars($theme); ?>">
          ...
          <?php if ($group['is_member']): ?>
            <div class="group-actions">
              ...
              <?php if ($group['is_admin']): ?>
                <a href="student_manage_group.php?id=<?php echo $groupId; ?>" class="btn btn-outline">
                ...
                <?php foreach ($sharedFolders as $folder): ?>
                  <div class="folder-card animate-fade">
                    ...
                    <div class="folder-actions">
                      <a href="student_view_shared_folder.php?group_id=<?php echo $groupId; ?>&folder_id=<?php echo $folder['folder_id']; ?>" 
    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
        ...
        <p class="text-sm" style="color: var(--text-light); margin-top: var(--space-sm);">
          You won't be able to access shared folders unless you're re-invited.
        </p>
      </div>
  ...
  <div class="bottom-nav-container">
    <nav class="bottom-nav">
      ...
      <a href="student_group.php" class="nav-item-mobile active">
        <i class="fas fa-users"></i>
        <span>Groups</span>
      </a>
